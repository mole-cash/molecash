# Support for Output Descriptors in Mole Core

Since Mole Core v0.17, there is support for Output Descriptors. This is a
...
existing Mole Core wallets, a convenience function `combo` is
