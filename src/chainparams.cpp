...
{
    const char* pszTimestamp = "NY Times 27/May/2024 JoCoin Start, Tornadoes and storms leave 15 dead across central US";
    const CScript genesisOutputScript = CScript() << ParseHex("04c025ffbc3643bc0bda5a88dc0ff4fc1b2dff33dceb89445021378aa2b1d19414e560b7097a6dd97b4a888f267864485c3808109bedfab9c88e407c4f0b8fb70c") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        assert(consensus.hashGenesisBlock == uint256S("0xedb272e003bf8d29e0264951217007194f6f30d6aaf0c212a03723efe46c93af"));
        assert(genesis.hashMerkleRoot == uint256S("0x922485ba267f0690f94da2fda93b47d1cd27ef94743bc04cdf85296ffda1a23b"));
        ...
        vSeeds.emplace_back("seed1.mole.cash");
        vSeeds.emplace_back("seed2.mole.cash");
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = {0x67, 0x88, 0xB2, 0x1E};
        base58Prefixes[EXT_SECRET_KEY] = {0x67, 0x88, 0xAD, 0xE4};
...
public:
    CTestNetParams() {
        ...
        consensus.nMinimumChainWork = uint256S("0x0000000000000000000000000000000000000000000000000000000100010001");// Start
        consensus.defaultAssumeValid = uint256S("0x4a280c0e150e3b74ebe19618e6394548c8a39d5549fd9941b9c431c73822fbd5"); // 1737876

        pchMessageStart[0] = 0x88; // 88 c7 1d 07
        ...
        genesis = CreateGenesisBlock(1716800654, 490540, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x759513bb39fa85c8e325fd7b1472692127095c652b35faa3558cc1b37997fa1d"));
        assert(genesis.hashMerkleRoot == uint256S("0x922485ba267f0690f94da2fda93b47d1cd27ef94743bc04cdf85296ffda1a23b"));
        ...
        vSeeds.emplace_back("testnet-seed1.mole.cash");
        vSeeds.emplace_back("testnet-seed2.mole.cash");

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,105);
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,196);
        base58Prefixes[SCRIPT_ADDRESS2] = std::vector<unsigned char>(1,58);
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        base58Prefixes[EXT_PUBLIC_KEY] = {0x67, 0x35, 0x87, 0xCF};
        base58Prefixes[EXT_SECRET_KEY] = {0x67, 0x35, 0x83, 0x94};
        ...
        checkpointData = {
            {
                {0, uint256S("759513bb39fa85c8e325fd7b1472692127095c652b35faa3558cc1b37997fa1d")}
            }
        };
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        pchMessageStart[0] = 0xb2; // b2 17 44 6b
        ...
        genesis = CreateGenesisBlock(1716800758, 5, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x4a84f97a9e4c9d4cce3e04c3d2cec2003d3eb02d72e2d3ca8f111fb169dc64b3"));
        assert(genesis.hashMerkleRoot == uint256S("0x922485ba267f0690f94da2fda93b47d1cd27ef94743bc04cdf85296ffda1a23b"));
        ...
        checkpointData = {
            {
                {0, uint256S("4a84f97a9e4c9d4cce3e04c3d2cec2003d3eb02d72e2d3ca8f111fb169dc64b3")},
            }
        };
