...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " mole-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  mole-tx [options] <hex-tx> [commands]  Update hex-encoded mole transaction\n" +
            "or:     mole-tx [options] -create [commands]   Create hex-encoded mole transaction\n" +
            "\n";
