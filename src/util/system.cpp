...
const char * const BITCOIN_CONF_FILENAME = "mole.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Mole";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/Mole";
#else
    // Unix-like
    return pathRet / ".mole";
#endif
