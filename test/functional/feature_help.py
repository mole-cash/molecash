...
"""Verify that starting mole with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start mole with -h for help text")
        ...
        self.log.info("Start mole with -version for version information")
        ...
        self.log.info("Start moled with -fakearg to make sure it does not start")
