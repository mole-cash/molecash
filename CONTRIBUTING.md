Contributing to Mole Core
============================

The Mole Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Mole Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/mole-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to mole-qt
...
The following applies to code changes to the Mole Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Mole
Network Protocol consensus changes.

Whether a pull request is merged into Mole Core rests with the project merge
...
Patches that change Mole consensus rules are considerably more involved than
...
Where a patch set proposes to change the Mole consensus, it must have been
...
The project leader is the release manager for each Mole Core release.
